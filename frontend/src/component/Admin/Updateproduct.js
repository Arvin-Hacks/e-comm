...
const UpdateProduct = () => {
    ...
    const getproductdata = async () => {
        let data = await fetch(`http://localhost:5000/product/getproductdetail/${params.id}`)
            ...
            <div className='add-product' >
                <Form>
                    ...
                    <Form.Group>
                        ...
                        <Col sm="10">
                            <Form.Control type="file" name='product-image' multiple
                                onChange={(e) => setSelected(e.target.files[0])}
                                defaultValue={selectedfile ? selectedfile.name : product.image} />
